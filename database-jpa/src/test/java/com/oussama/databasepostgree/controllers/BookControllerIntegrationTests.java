...
public class BookControllerIntegrationTests {
    ...
    public void testThatListAuthorsReturnsListOfAuthors() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$[0].isbn").value("343-1-4324-6756-0")
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$[0].title").value("The Lord of the Rings")
        );
    }
    ...
    public void testThatGetBookReturnsHttpStatus404WhenNoBookExists() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.get("/books/343-1-4324-6756-0")
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
    ...
    public void testThatPartialUpdateBookReturnsHttpStatus200Ok() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.patch("/books/343-1-4324-6756-0")
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
                MockMvcResultMatchers.status().isOk()
        );
    ...
    public void testThatDeleteNonExistingBookReturnsHttpStatus204NoContent() throws Exception {
        mockMvc.perform(
                MockMvcRequestBuilders.delete("/books/4543532452345")
                        .contentType(MediaType.APPLICATION_JSON)
        ).andExpect(
